...
自然语言处理(NLP)领域的革命从注意力机制\citeext{Bahdanau2015}的奠基，Transformer架构\citeext{Vaswani2017}点燃了导火索，到BERT模型\citeext{Devlin2019}正式拉开革命帷幕，以简单的注意力机制模型取代了曾经是NLP主流的相对复杂的RNN系列模型，并在模型性能、扩展性以及速度上都取得了极大的提升，４年间全面改变了NLP领域，造就了NLP领域的ImageNet时刻\citeext{ruder2018nlpimagenet}。
